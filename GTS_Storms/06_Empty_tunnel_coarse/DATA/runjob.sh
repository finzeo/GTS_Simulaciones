#!/bin/bash
#SBATCH --job-name=SSempty # nombre para identificar el trabajo. Por defecto es el nombre del script # Autor-SimMall-NumCaso-NumMalla
#SBATCH --ntasks=192 # cantidad de cores pedidos
