#!/bin/bash
#SBATCH --job-name=SS1205 # nombre para identificar el trabajo. Por defecto es el nombre del script # Autor-SimMall-NumCaso-NumMalla
#SBATCH --ntasks=128 # cantidad de cores pedidos
