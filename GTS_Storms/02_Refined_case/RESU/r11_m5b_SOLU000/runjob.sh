#!/bin/bash
#SBATCH --job-name=SS0103 # nombre para identificar el trabajo. Por defecto es el nombre del script # Autor-SimMall-NumCaso-NumMalla
#SBATCH --ntasks=256 # cantidad de cores pedidos
...
#SBATCH --nodelist=n-8,n-9,n-10,n-11,n-12,n-13,n-14,n-15
