...
cs_user_extra_operations(cs_domain_t     *domain)
{
    ...
    //if (b_forces != NULL) {
      ...
      cs_selector_get_b_face_list("gtsModel or gtsCorners", &n_elts, lst_elts);
      // Another example:
    ...
    cs_selector_get_b_face_list("gtsModel or gtsCorners", &n_elts_p, lst_elts_p);
  ...
  // (name set at snappyHexMeshDict)
  // Creo que se pueden usar operadores logicos
  cs_selector_get_b_face_list("gtsModel or gtsCorners", &n_elts_y, lst_elts_y);
