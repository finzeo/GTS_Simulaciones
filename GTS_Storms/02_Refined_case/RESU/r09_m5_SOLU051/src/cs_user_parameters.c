...
cs_user_model(void)
{
  ...
  glob_turb_ref_values->almax = 2.47648095; //2.510117647; //0.439630802;
...
//  }
  ...
  */
  ...
  //{
  //  cs_equation_param_t *eqp1 = cs_field_get_equation_param(CS_F_(p));
  //  eqp1->iswdyn = 2;
  //  cs_equation_param_t *eqp2 = cs_field_get_equation_param(CS_F_(vel));
  //  eqp2->iswdyn = 2;
  //}
