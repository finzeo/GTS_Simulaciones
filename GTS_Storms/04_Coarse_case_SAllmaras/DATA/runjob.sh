#!/bin/bash
#SBATCH --job-name=SStestSA # nombre para identificar el trabajo. Por defecto es el nombre del script # Autor-SimMall-NumCaso-NumMalla
...
#SBATCH --nodelist=n-16,n-17,n-18,n-19
